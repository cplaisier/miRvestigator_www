...
<p>Post-transcriptional regulation by a miRNA is mediated through binding to comlementary sequences in the 3\' untranslated regions (UTRs) of transcripts and generates a biological context-specific signature of down-regulation, which is observed in transcriptome studies as a co-expression signature. Co-expression therefore is assumed to be a biological process whereby the expression of genes is regulated by shared factors (transcription factor, miRNAs, genetics or enrivnmental factors). To identify a set of co-expressed genes use your favorite method such as <a href='http://en.wikipedia.org/wiki/Cluster_analysis' style=\'color: rgb(204,204,0)\' target='_blank'>clustering</a>.</p>
