...
def results(req):
    ...
    s += ''
    s += '</td><td bgcolor=\'#666666\' align=\'center\' valign=\'center\'><table width=\'100%\' cellpadding=\'5%\'><tr><td bgcolor=\'#ffffff\'><center><span id="genes_submitted"></span> <span style="color:#ff0000">(<a href="/genes/' + id + '/">gene mapping as CSV</a>)</span></center></td></tr></table></td></tr>\n'
