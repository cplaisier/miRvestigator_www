...
def results(req):
    ...
    for motif in motifs:
        ...
        if topRet=='all':
            ...
            topRet = int(topRet)
        s += '<table width="100%%" style="background:#333333;"><tr><td style="text-align:right; color: #eeeeee;"><a href="/scores/csv/%s">download as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
        ...
        s += '</font></td></td></table>'
        s += '<table width="100%%" style="background:#333333;"><tr><td style="text-align:right; color: #eeeeee;"><a href="/sites/csv/%s">download as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
