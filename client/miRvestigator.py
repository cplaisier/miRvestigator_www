...
def results(req):
    ...
    for motif in motifs:
        ...
        if topRet=='all':
            ...
            topRet = int(topRet)
        s += '<table width="100%%" cellpadding="15%%"><tr><td style="text-align:center; font-size:10pt; background:#cccccc;"><a href="/scores/csv/%s">download table as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
        ...
        s += '</font></td></td></table>'
        s += '<table width="100%%" cellpadding="15%%"><tr><td style="text-align:center; font-size:10pt; background:#cccccc;"><a href="/sites/csv/%s">download table as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
