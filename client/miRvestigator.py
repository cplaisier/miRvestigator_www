...
def results(req):
    ...
    for motif in motifs:
        ...
        if topRet=='all':
            ...
            topRet = int(topRet)
        s += '<table width="100%%" style="background:#333333; margin-right: 1px; margin-left: 1px;"><tr><td style="text-align:right; font-size:10pt;"><a href="/scores/csv/%s">download as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
        ...
        s += '</font></td></td></table>'
        s += '<table width="100%%" style="background:#333333; margin: 2px 1px, 2px, 1px;"><tr><td style="text-align:right; font-size:10pt;"><a href="/sites/csv/%s">download as CSV</a></td></tr></table>\n' % (motif['motif_id'],)
