...
def results(req):
    ...
    s += '<tr><td bgcolor=\'#000000\'><center><font color=\'#cccc00\' size=4><b><a href="#subParams" onclick="toggleVisible(\'subParams\'); return false;" style=\'color: rgb(204,204,0); text-decoration: none\'>Submission Parameters <font color=\'#ff0000\'>[+]</font></a></b></font></center></td></tr>\n'
