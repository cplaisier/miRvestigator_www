...
def results(req):
    ...
    s += '<tr><td bgcolor=\'#333333\' align=\'center\' valign=\'center\'><font color=\'#ffffff\'><b>Genes Submitted:</b></font> <span style="color:#ff0000">(<a href="/genes/' + id + '/">gene mapping as CSV</a>)</span>'
