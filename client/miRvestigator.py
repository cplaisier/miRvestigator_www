...
def index():
    s = """\
            ...
            <tr id="geneList" style="display: none;"><td colspan=2 bgcolor='#333333'><font color='#ffffff'><b>Gene Co-Expression</b>
<p>Co-expression is assumed to be a biological process whereby the expression of genes is regulated by shared factors (transcription factor, miRNAs, genetics or enrivnmental factors). To identify a set of co-expressed genes use your favorite method such as <a href='http://en.wikipedia.org/wiki/Cluster_analysis' style=\'color: rgb(204,204,0)\' target='_blank'>clustering</a>.</p>
...
<p>You can enter the Entrez gene IDs separated by commas, spaces, tabs or <a href='http://en.wikipedia.org/wiki/Newline' style=\'color: rgb(204,204,0)\' target='_blank'>newlines</a>.</p></font></td></tr>
            ...
            <b>Loading and Using Sample Data</b> <p>Load the data by simply clicking the button with the corresponding miRNA on it, which will load the data and setup any parameters. Then click the submit button at the bottom of the page. The algorithm will identify the miRNA loaded as the top hit.</p>
            </font></td></tr>
            <tr><td><td></tr>
            ...
            <p>The miRvestiator <a href='http://en.wikipedia.org/wiki/Hidden_Markov_model' style='color: rgb(204,204,0)' target='_blank'>hidden Markov model (HMM)</a> is a method designed to take an over-represetned <a href='http://en.wikipedia.org/wiki/Sequence_motif' style='color: rgb(204,204,0)' target='_blank'>sequence motif</a> (in this case from <a href='http://159.149.109.9/modtools' style='color: rgb(204,204,0)' target='_blank'>Weeder</a>) and compare it to all the miRNA seed seqeunces from <a href='http://www.mirbase.org' style='color: rgb(204,204,0)' target='_blank'>miRBase</a> using the <a href='http://en.wikipedia.org/wiki/Viterbi_algorithm' style='color: rgb(204,204,0)' target='_blank'>Viterbi algortihm</a>. The over-represented seqeunce motif is turned into a profile HMM and each seed sequence in miRBase is aligned and a probability computed using the Viterbi algorithm. Then a Viterbi p-value is calcuated for each miRNA by comparing it to an exhaustive distribution of Viterbi probabilities.<p>
            ...
            <p>The miRvestigator HMM can also model G:U wobble base-pairing which has been observed in miRNA to target transcript 3' UTR complementarity. The seqeunce motif is unlikely to be comprised of instances where a G:U wobble was used in the exact same spot. However, it may be possible and we do not want to exclude the possibility. Thus the miRvestigator framework can be enabled to model these G:U base pairings once the G or U nucleotide frequency in the seqeunce motif column passes a specified threshold. This threshold can be set with the "Min. Freq. of G or U". By default the wobble base-pairing is not modeled but if it was we would reccomend a threshold of 0.25 for the "Min. Freq. of G or U".</p>
            </font></td></tr>
